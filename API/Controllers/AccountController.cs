...
public class AccountController : ControllerBase
{
    ...
    public AccountController(IAccountRepository accountRepository, IEmployeeRepository employeeRepository, IAccountRoleRepository accountRoleRepository, IRoleRepository roleRepository, ITokenHandler tokenHandler)
    {
        ...
        using var transaction = new TransactionScope();
        {
            try
            {
                ...
                var accountRole = _accountRoleRepository.Create(new AccountRole
                {
                    ...
                    RoleGuid = registerAccountDto.RoleGuid
    ...
    public IActionResult Login(LoginDto loginDto)
    {
        try
            ...
            claims.Add(new Claim("Guid", employees.Guid.ToString(), ClaimValueTypes.String));
            ...
            claims.Add(new Claim("NIK", employees.Nik));
            claims.Add(new Claim("ProfilePhoto", stringPhoto));
